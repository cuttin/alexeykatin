...
Results show that constraining summer riverine inputs based on spring conditions, including precipitation over the Mississippi River basin, can be used to improve hypoxia forecasting skill. We also show that inclusion of spring wind data further enhances hypoxia forecasts. Overall, retrospective forecasts explain about 50% of the temporal variability in hypoxic area for two different sections of the Louisiana–Texas shelf (1985−2016). In addition, the forecasting approach explicitly quantifies the uncertainty associated with model parameters, variability in data inputs, and residual error, allowing for risk-based ecosystem management.
